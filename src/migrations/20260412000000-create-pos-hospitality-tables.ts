...
export class CreatePosHospitalityTables20260412000000
  implements MigrationInterface
{
  name = 'CreatePosHospitalityTables20260412000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS "pos_hospitality_kitchen_tickets" (
        ...
        CONSTRAINT "PK_pos_hospitality_kitchen_tickets_id" PRIMARY KEY ("id"),
        CONSTRAINT "uq_pos_hospitality_kitchen_ticket_branch_ticket" UNIQUE ("branchId", "ticketId")
      )
    `);
    await queryRunner.query(
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS "pos_hospitality_table_board" (
        ...
        "createdAt" TIMESTAMPTZ NOT NULL DEFAULT now(),
        "updatedAt" TIMESTAMPTZ NOT NULL DEFAULT now(),
        CONSTRAINT "PK_pos_hospitality_table_board_id" PRIMARY KEY ("id"),
        CONSTRAINT "uq_pos_hospitality_table_board_branch_table" UNIQUE ("branchId", "tableId")
      )
    `);
    await queryRunner.query(
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS "pos_hospitality_bill_interventions" (
        ...
        "createdAt" TIMESTAMPTZ NOT NULL DEFAULT now(),
        "updatedAt" TIMESTAMPTZ NOT NULL DEFAULT now(),
        CONSTRAINT "PK_pos_hospitality_bill_interventions_id" PRIMARY KEY ("id"),
        CONSTRAINT "uq_pos_hospitality_bill_intervention_branch_bill" UNIQUE ("branchId", "billId")
      )
    `);
    await queryRunner.query(
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS "pos_hospitality_idempotency_keys" (
        ...
        "createdAt" TIMESTAMPTZ NOT NULL DEFAULT now(),
        CONSTRAINT "PK_pos_hospitality_idempotency_keys_id" PRIMARY KEY ("id"),
        CONSTRAINT "uq_pos_hospitality_idempotency_branch_key" UNIQUE ("branchId", "idempotencyKey")
      )
    `);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_pos_hospitality_idempotency_branch_created"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_pos_hospitality_bill_intervention_branch_priority"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_pos_hospitality_bill_intervention_branch_action"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_pos_hospitality_bill_intervention_branch_updated"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_pos_hospitality_table_board_branch_area"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_pos_hospitality_table_board_branch_status"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_pos_hospitality_table_board_branch_updated"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_pos_hospitality_kitchen_ticket_branch_state"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_pos_hospitality_kitchen_ticket_branch_station"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_pos_hospitality_kitchen_ticket_branch_updated"`,
    );
    await queryRunner.query(
