...
export class ChangeRolesToTextArray1689690000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "roles" TYPE text[] USING string_to_array(roles, ',')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "roles" TYPE text USING array_to_string(roles, ',')`);
    }
}
