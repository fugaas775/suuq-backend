...
export class AddCurrencyToOrder1767931200697 implements MigrationInterface {
    name = 'AddCurrencyToOrder1767931200697'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "order" ADD "currency" character(3) NOT NULL DEFAULT 'USD'`);
        await queryRunner.query(`ALTER TABLE "order" ADD "exchange_rate" numeric(10,4) NOT NULL DEFAULT '1'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "order" DROP COLUMN "exchange_rate"`);
