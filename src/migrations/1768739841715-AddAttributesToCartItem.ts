...
export class AddAttributesToCartItem1768739841715 implements MigrationInterface {
    name = 'AddAttributesToCartItem1768739841715'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "order_item" ADD "attributes" jsonb NOT NULL DEFAULT '{}'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "commissionRate" SET DEFAULT 0.05`);
        await queryRunner.query(`ALTER TABLE "order_item" DROP COLUMN "attributes"`);
    }
