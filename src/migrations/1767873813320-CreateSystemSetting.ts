...
export class CreateSystemSetting1767873813320 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "system_setting" ("id" SERIAL NOT NULL, "key" character varying NOT NULL, "value" jsonb NOT NULL, "description" character varying, CONSTRAINT "UQ_c6ce0e35b3c0d67dca93523ba1b" UNIQUE ("key"), CONSTRAINT "PK_88dbc9b10c8558420acf7ea642f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
