...
export class AddMetadataToTopUpRequest1767876475379 implements MigrationInterface {
    name = 'AddMetadataToTopUpRequest1767876475379'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "top_up_request" ADD "metadata" jsonb`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "top_up_request" DROP COLUMN "metadata"`);
    }
