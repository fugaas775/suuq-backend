...
export class AddEbirrTransaction1769162306470 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "product_impression" ADD CONSTRAINT "FK_5745616022b9f0348088098f646" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "product_impression" DROP CONSTRAINT "FK_5745616022b9f0348088098f646"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "product_impression" ADD CONSTRAINT "FK_product_impression_user" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }
}
