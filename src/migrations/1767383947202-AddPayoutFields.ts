...
export class AddPayoutFields1767383947202 implements MigrationInterface {
  name = 'AddPayoutFields1767383947202';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "user" ADD "bankAccountHolderName" character varying(128)`,
    );
    await queryRunner.query(
      `ALTER TABLE "withdrawal" ADD "payoutDetails" jsonb`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "withdrawal" DROP COLUMN "payoutDetails"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" DROP COLUMN "bankAccountHolderName"`,
    );
  }
}
