...
export class AddDeliveryAcceptanceStatus1770299411307
  implements MigrationInterface
{
  name = 'AddDeliveryAcceptanceStatus1770299411307';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."order_deliveryacceptancestatus_enum" AS ENUM('PENDING', 'ACCEPTED', 'REJECTED')`,
    );
    await queryRunner.query(
      `ALTER TABLE "order" ADD "deliveryAcceptanceStatus" "public"."order_deliveryacceptancestatus_enum"`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "order" DROP COLUMN "deliveryAcceptanceStatus"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."order_deliveryacceptancestatus_enum"`,
    );
  }
}
