...
export class AddMoqAndDispatchToProduct1768731244206 implements MigrationInterface {
    name = 'AddMoqAndDispatchToProduct1768731244206'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "product" ADD "moq" integer NOT NULL DEFAULT '1'`);
        await queryRunner.query(`ALTER TABLE "product" ADD "dispatch_days" integer`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "commissionRate" SET DEFAULT 0.05`);
        await queryRunner.query(`ALTER TABLE "product" DROP COLUMN "dispatch_days"`);
        await queryRunner.query(`ALTER TABLE "product" DROP COLUMN "moq"`);
    }
