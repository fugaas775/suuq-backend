...
export class AddUserLocation1724236800000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "user" ADD COLUMN "locationLat" double precision`);
    await queryRunner.query(`ALTER TABLE "user" ADD COLUMN "locationLng" double precision`);
  }
