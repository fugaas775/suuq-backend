import { Controller, Get, Post, Body, Param, UseGuards, Req, ParseIntPipe, Patch, Query, UseInterceptors } from '@nestjs/common';
...
import { ApiTags, ApiOkResponse, ApiQuery, ApiParam, ApiBody } from '@nestjs/swagger';
...
export class OrdersController {
  ...
  findAll(@Req() req: AuthenticatedRequest, @Query('page') page = 1, @Query('limit') limit = 10) {
