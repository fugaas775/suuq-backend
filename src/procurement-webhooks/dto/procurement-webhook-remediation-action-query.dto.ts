...
export class ProcurementWebhookRemediationActionQueryDto {
  ...
  @ApiPropertyOptional({
    description:
      'Opaque cursor returned by the previous remediation-actions page to continue scanning older entries.',
  })
  @IsOptional()
  @IsString()
  cursor?: string;
  ...
  @ApiPropertyOptional({
    enum: ProcurementWebhookSubscriptionRemediationActionType,
  })
  @IsOptional()
  @IsEnum(ProcurementWebhookSubscriptionRemediationActionType)
  ...
  @ApiPropertyOptional({
    description:
      'Filter replay remediation actions by whether they used a preview-confirmed execution token.',
  })
  @IsOptional()
  @Transform(({ value }) => {
