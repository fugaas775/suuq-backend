...
export class AddChurnRecoveryFields1767576810399 implements MigrationInterface {
  name = 'AddChurnRecoveryFields1767576810399';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "user" ADD "lastRenewalReminderAt" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" ADD "renewalReminderCount" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user" DROP COLUMN "renewalReminderCount"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" DROP COLUMN "lastRenewalReminderAt"`,
    );
  }
}
