...
export class AddTelebirr1768273369695 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "telebirr_transaction" ("id" SERIAL NOT NULL, "merch_order_id" character varying NOT NULL, "trans_id" character varying, "payment_order_id" character varying, "status" character varying NOT NULL DEFAULT 'PENDING', "amount" numeric(10,2) NOT NULL, "payer_msisdn" character varying, "raw_response" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_ab8e05e578a4f464f7a2b13b7b5" UNIQUE ("merch_order_id"), CONSTRAINT "PK_aef3e4b05c77fd66fa9a57c52ae" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" ADD "telebirrAccount" character varying(32)`,
    );
    await queryRunner.query(
      `ALTER TABLE "vendor" ADD "telebirr_account" character varying(32)`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "vendor" DROP COLUMN "telebirr_account"`,
    );
