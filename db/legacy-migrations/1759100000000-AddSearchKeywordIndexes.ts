 ...
 */
export class AddSearchKeywordIndexes1759100000000
  implements MigrationInterface
{
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'DROP INDEX IF EXISTS "IDX_search_keyword_qnorm_trgm"',
    );
    await queryRunner.query(
      'DROP INDEX IF EXISTS "IDX_search_keyword_last_country"',
    );
    await queryRunner.query(
      'DROP INDEX IF EXISTS "IDX_search_keyword_last_vendor_name"',
    );
    await queryRunner.query(
      'DROP INDEX IF EXISTS "IDX_search_keyword_last_city"',
    );
    await queryRunner.query(
      'DROP INDEX IF EXISTS "IDX_search_keyword_last_seen_at"',
    );
    await queryRunner.query(
      'DROP INDEX IF EXISTS "IDX_search_keyword_submit_last"',
    );
  }
}
