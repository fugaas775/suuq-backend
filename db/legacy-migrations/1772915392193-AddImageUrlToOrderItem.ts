...
export class AddImageUrlToOrderItem1772915392193 implements MigrationInterface {
  name = 'AddImageUrlToOrderItem1772915392193';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "order_item" ADD "image_url" character varying(1024)`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."product_request_status_enum_old" AS ENUM('CANCELLED', 'EXPIRED', 'FULFILLED', 'IN_PROGRESS', 'OPEN')`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_request" ALTER COLUMN "status" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."product_request_urgency_enum_old" AS ENUM('FLEXIBLE', 'IMMEDIATE', 'THIS_WEEK')`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_request" ALTER COLUMN "urgency" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."product_request_offer_status_enum_old" AS ENUM('ACCEPTED', 'EXPIRED', 'REJECTED', 'SEEN', 'SENT', 'WITHDRAWN')`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_request_offer" ALTER COLUMN "status" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(`ALTER TABLE "order_item" DROP COLUMN "image_url"`);
  }
}
